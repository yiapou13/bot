...
export default {
    app: {
        gateway: get_gateway_url('https://prodigy-chat-ec236.gateway.dialogflow.cloud.ushakov.co'), // <- enter your gateway URL here, the function is just a helper function for my hosted integration. You don't normally need it
